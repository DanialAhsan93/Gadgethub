...
export default function Tvfeat() {
    const settings = {
        dots: false,
        infinite: true,
        speed: 500,
    ...
    const [slider, setslider] = useState(tvdata);
    // console.log(slider)
    ...
    const goToNextProduct = () => {
        ...
        navigate(`/tvfeat`, { state: { post: data[nextProductIndex] } });
    };

    const goToPrevProduct = () => {
        const prevProductIndex = (currentProductIndex - 1 + data.length) % data.length;
        navigate(`/tvfeat`, { state: { post: data[prevProductIndex] } });
    };
    ...
    const saleTag = ['TV4', 'TV3', 'TV7', 'TV6'].includes(post.id);
    const remainTag = ['TV1', 'TV2', 'TV5', 'TV8'].includes(post.id);
                ...
                <section className='mobilefeat-sec'>
                    <div className="container-fluid">
                        <div className="row justify-content-around px-xxl-0 px-xl-0 px-lg-3 px-md-4 py-sm-5 mt-sm-0 mt-4 ">
                            <div className="col-sm-8  ps-sm-4">
                                ...
                                <div className='d-flex align-items-center d-sm-none ' style={{ fontSize: '18px' }}>
                                    <Link to={'/tv'} style={{ textDecoration: 'none', color: 'black' }}>
                                        ...
                                        <span>Back to TV & Home Cinema</span>
                                    </Link>
                                </div>
                            </div>
                            <div className="col-sm-3 pe-sm-5">
                        ...
                        <div className="row justify-content-center mt-sm-0 mt-5 px-sm-5">
                            ...
                            <div className="row pt-sm-5 mt-5 px-sm-5">
                                ...
                                <Slider {...settings}>
                                    ...
                                    {slider.map((post, id) => {
                                        ...
                                        const saleItemTag = ['TV4', 'TV3', 'TV7', 'TV6'].includes(itemid);
                                        const remainItemTag = ['TV1', 'TV2', 'TV5', 'TV8'].includes(itemid);
                                        return (

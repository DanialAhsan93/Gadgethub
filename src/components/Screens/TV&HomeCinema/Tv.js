...
const dispatch = useDispatch()
    ...
    const filterFunction = (data) => {
        ...
        const idstoshow = ['TV3', 'TV4', 'TV6', 'TV7'];
        const showAll = ['TV1', 'TV2', 'TV3', 'TV4','TV5', 'TV6', 'TV7', 'TV8'];
      
        const filterAll = (post) => idstoshow.includes(post.id) || showAll.includes(post.id);
        const filterSale = (post) => ['TV3', 'TV4', 'TV6', 'TV7'].includes(post.id);
        const filterBestSeller = (post) => ['TV1', 'TV2', 'TV5', 'TV8'].includes(post.id);
    ...
    const sortMbldata = (data, option) => {
        const discpriceIds = ['TV3', 'TV4', 'TV6', 'TV7']; // IDs of items with discprice
        const regularIds = ['TV1', 'TV2', 'TV5', 'TV8']; // IDs of regular items
    ...
    const filteredAndSortedData = sortMbldata(filterFunction(tvdata), sortOption);
    ...
    <>
     <section className='mbl-sect'>
                <div className="container-fluid py-sm-5">
                    <h1 className='mbl-head text-center pt-sm-2'>TV & Home Cinema</h1>

...
import { dronesdata } from './Dronesdata';
...
export default function Dronesfeat() {
    const settings = {
        dots: false,
        infinite: true,
        speed: 500,
    ...
    const [slider, setslider] = useState(dronesdata);
    console.log(slider)
    ...
    const goToNextProduct = () => {
        ...
        navigate(`/dronesfeat`, { state: { post: data[nextProductIndex] } });
    };

    const goToPrevProduct = () => {
        const prevProductIndex = (currentProductIndex - 1 + data.length) % data.length;
        navigate(`/dronesfeat`, { state: { post: data[prevProductIndex] } });
    };
    ...
    const saleTag = ['D4', 'D3', 'D7', 'D6'].includes(post.id);
    const remainTag = ['D1', 'D2', 'D5', 'D8'].includes(post.id);
            ...
            <div className='container'>
                ...
                <section className='mobilefeat-sec'>
                    <div className="container-fluid">
                        <div className="row justify-content-around px-4 py-sm-5 mt-sm-0 mt-4 ">
                            ...
                            ms-md-0 ms-sm-0">
                                <div className="d-sm-flex d-none  justify-content-start">
                                    ...
                                    <Link style={{ textDecoration: 'none', color: 'black' }} to={'/drones'}>
                                ...
                                <div className='d-flex align-items-center d-sm-none ' style={{ fontSize: '18px' }}>
                                    <Link to={'/drones'} style={{ textDecoration: 'none', color: 'black' }}>
                                        <span><IoIosArrowBack /></span>
                                        <span>Back to Drones & Cameras</span>
                                    </Link>
                                </div>
                            </div>
                            ...
                            <div className="row pt-sm-5 mt-5 px-sm-5">
                                ...
                                <Slider {...settings}>
                                    ...
                                    {slider.map((post, id) => {
                                        ...
                                        const saleItemTag = ['D4', 'D3', 'D7', 'D6'].includes(itemid);
                                        const remainItemTag = ['D1', 'D2', 'D5', 'D8'].includes(itemid);
                                        return (

...
export default function Drones() {
    const [data, setdata] = useState(dronesdata);
    // console.log(data)
    ...
    const filterFunction = (data) => {
        ...
        const idstoshow = ['D4', 'D3', 'D7', 'D6'];
        const showAll = ['D1', 'D2', 'D5', 'D8', 'D4', 'D3', 'D7', 'D6'];

        const filterAll = (post) => idstoshow.includes(post.id) || showAll.includes(post.id);
        const filterSale = (post) => ['D4', 'D3', 'D7', 'D6'].includes(post.id);
        const filterBestSeller = (post) => ['D1', 'D2', 'D5', 'D8'].includes(post.id);
    ...
    const sortMbldata = (data, option) => {
        const discpriceIds = ['D4', 'D3', 'D7', 'D6']; // IDs of items with discprice
        const regularIds = ['D1', 'D2', 'D5', 'D8']; // IDs of regular items
    ...
    const filteredAndSortedData = sortMbldata(filterFunction(dronesdata), sortOption);
    return (
        <>
            <section className='mbl-sect'>
                <div className="container-fluid py-sm-5">
                    <h1 className='mbl-head text-center pt-sm-2'>Drones & Cameras</h1>

...
export default function Tabletfeat() {
    ...
    const [slider, setslider] = useState(tabdata);
    // console.log(slider)
    ...
    const goToNextProduct = () => {
        ...
        navigate(`/tabfeat`, { state: { post: data[nextProductIndex] } });
    };

    const goToPrevProduct = () => {
        const prevProductIndex = (currentProductIndex - 1 + data.length) % data.length;
        navigate(`/tabfeat`, { state: { post: data[prevProductIndex] } });
    };
    ...
    const saleTag = ['T4', 'T3', 'T7', 'T6'].includes(post.id);
    const remainTag = ['T1', 'T2', 'T5', 'T8'].includes(post.id);
                    ...
                    <div className="container-fluid px-md-2 px-0">
                        <div className="row justify-content-around px-4 py-sm-5 mt-sm-0 mt-4 ">
                            ...
                            ms-md-0 ms-sm-0">
                                <div className="d-sm-flex d-none  justify-content-start">
                                    ...
                                    <Link style={{ textDecoration: 'none', color: 'black' }} to={'/tab'}>
                                ...
                                <div className='d-flex align-items-center d-sm-none ' style={{ fontSize: '18px' }}>
                                    <Link to={'/tab'} style={{ textDecoration: 'none', color: 'black' }}>
                        ...
                        <div className="row justify-content-center mt-sm-0 mt-5 px-lg-5 px-md-0  px-sm-5">
                            ...
                            <div className="col-md-6 col-sm-6 text-start pe-lg-5 ps-sm-4">
                                ...
                                <p className='sku-feat d-sm-flex '>{location?.state?.post.SKU}</p>
                            ...
                            <div className="row pt-sm-5 mt-5 px-sm-5">
                                ...
                                <Slider {...settings}>
                                    ...
                                    {slider.map((post, id) => {
                                        ...
                                        const saleItemTag = ['T4', 'T3', 'T7', 'T6'].includes(itemid);
                                        const remainItemTag = ['T1', 'T2', 'T5', 'T8'].includes(itemid);
                                        return (

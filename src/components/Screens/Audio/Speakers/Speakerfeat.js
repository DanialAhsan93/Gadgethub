...
export default function Speakerfeat() {
    ...
    const [slider, setslider] = useState(speakdata);
    ...
    const goToNextProduct = () => {
        ...
        navigate(`/speakerfeat`, { state: { post: data[nextProductIndex] } });
    };

    const goToPrevProduct = () => {
        const prevProductIndex = (currentProductIndex - 1 + data.length) % data.length;
        navigate(`/speakerfeat`, { state: { post: data[prevProductIndex] } });
    };
    ...
    const saleTag = ['S4', 'S3', 'S7', 'S6'].includes(post.id);
    const remainTag = ['S1', 'S2', 'S5', 'S8'].includes(post.id);
            ...
            <div className="container">
                ...
                <section className='mobilefeat-sec'>
                    <div className="container-fluid">
                        <div className="row justify-content-around px-md-4 py-sm-5 mt-sm-0 mt-4 ">
                            ...
                            ms-md-0 ms-sm-0 ">
                                <div className="d-sm-flex d-none  justify-content-start">
                                    ...
                                    <Link style={{ textDecoration: 'none', color: 'black' }} to={'/speaker'}>
                                ...
                                <div className='d-flex align-items-center d-sm-none ' style={{ fontSize: '18px' }}>
                                    <Link to={'/speaker'} style={{ textDecoration: 'none', color: 'black' }}>
                            ...
                            <div className="col-md-6  col-sm-4 text-start pe-lg-5  ps-sm-4">
                             ...
                             align-items-center mt-3">
                                    <div className='' data-bs-toggle="offcanvas" data-bs-target="#offcanvasLarge"
                                        aria-controls="offcanvasLarge" onClick={() => send(post)}>
                            ...
                            <div className="row pt-sm-5 mt-5 px-sm-5">
                                ...
                                <Slider {...settings}>
                                    ...
                                    {slider.map((post, id) => {
                                        ...
                                        const saleItemTag = ['S4', 'S3', 'S7', 'S6'].includes(itemid);
                                        const remainItemTag = ['S1', 'S2', 'S5', 'S8'].includes(itemid);
                                        return (

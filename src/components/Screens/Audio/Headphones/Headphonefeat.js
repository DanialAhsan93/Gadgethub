...
export default function Headphonefeat() {
    const settings = {
        dots: false,
        infinite: true,
        speed: 500,
    ...
    const [slider, setslider] = useState(headdata);
    console.log(slider)
    ...
    const goToNextProduct = () => {
        ...
        navigate(`/headphfeat`, { state: { post: data[nextProductIndex] } });
    };

    const goToPrevProduct = () => {
        const prevProductIndex = (currentProductIndex - 1 + data.length) % data.length;
        navigate(`/headphfeat`, { state: { post: data[prevProductIndex] } });
    };
    ...
    const saleTag = ['head4', 'head3', 'head7', 'head6'].includes(post.id);
    const remainTag = ['head1', 'head2', 'head5', 'head8'].includes(post.id);
            ...
            <div className='container'>
                ...
                <section className='mobilefeat-sec'>
                    <div className="container-fluid">
                        <div className="row justify-content-center px-xl-0 px-lg-3 px-md-n-4   py-sm-5 mt-sm-0 mt-4 ">
                            ...
                            ms-md-0 ms-sm-0">
                                <div className="d-sm-flex d-none  justify-content-start">
                                    ...
                                    <Link style={{ textDecoration: 'none', color: 'black' }} to={'/headph'}>
                                ...
                                <div className='d-flex align-items-center d-sm-none ' style={{ fontSize: '18px' }}>
                                    <Link to={'/headph'} style={{ textDecoration: 'none', color: 'black' }}>
                                        <span><IoIosArrowBack /></span>
                                        <span>Back to Headphone</span>
                                    </Link>
                                </div>
                            </div>
                        ...
                        <div className="row justify-content-center mt-sm-0 mt-5  px-lg-5 px-md-0 px-sm-5">
                            <div className="col-md-6 col-sm-5 padding-start-lg-35 pe-2 ">
                            ...
                            <div className="col-md-6 col-sm-4 text-start pe-lg-5 ps-sm-4">
                                ...
                                <div className='d-flex'>
                                    {saleTag && <del className='mblprice-feat'>{post.price}</del>}
                                    {saleTag && <p className='mblprice-feat ps-2'>{post.discprice}</p>}

                                </div>
                                {remainTag && <p className='mblprice-feat'>{post.price}</p>}
                            ...
                            <div className="row pt-sm-5 mt-5 px-sm-5">
                                ...
                                <Slider {...settings}>
                                    ...
                                    {slider.map((post, id) => {
                                        ...
                                        const saleItemTag = ['head4', 'head3', 'head7', 'head6'].includes(itemid);
                                        const remainItemTag = ['head1', 'head2', 'head5', 'head8'].includes(itemid);
                                        return (
